    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/blog" className="hover:text-green-300 transition-colors">Blog</a></li>
              <li><a href="/how-to-grow" className="hover:text-green-300 transition-colors">How to Grow</a></li>
              <li><a href="/pest-and-disease" className="hover:text-green-300 transition-colors">Pest and Disease</a></li>
              <li><a href="/qna" className="hover:text-green-300 transition-colors">Q&A</a></li>
            </ul>
          </div>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              <li>Email: <a href="mailto:info@greenroots.com" className="hover:text-green-300 transition-colors">info@greenroots.com</a></li>
              <li>Phone: <a href="tel:+1234567890" className="hover:text-green-300 transition-colors">+1 (234) 567-890</a></li>
              <li>Address: 123 Green Street, Farmville, Earth</li>
            </ul>
          </div>
        ...
        <div className="border-t border-green-800 mt-8 pt-8 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Green Roots. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
