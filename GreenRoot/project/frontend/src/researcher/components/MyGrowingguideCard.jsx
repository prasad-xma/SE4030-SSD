...
export default function MyGrowingguideCard({post}) {
  ...
  return (
    <div className="w-full mb-2 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex justify-end space-x-2 mt-2">
          <Link 
            to="/researcher/my-growing-guide/update" 
            state={{ post }}
